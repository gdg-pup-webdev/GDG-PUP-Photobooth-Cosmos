    ...
    >
      ...
      <div
        ...
        style={{
          background: disabled
            ? "#444"
            : `conic-gradient(${colors.cyan}, ${colors.blue}, #A855F7, ${colors.white}, ${colors.cyan})`,
          ...
          <div
            ...
            style={{
              background: disabled
                ? "#555"
                : isCapturing
                ? `linear-gradient(135deg, #A855F7, ${colors.blue})`
                : `linear-gradient(135deg, ${colors.cyan}, ${colors.blue})`,
              boxShadow: disabled
                ? "none"
                : `0 0 30px ${isCapturing ? "#A855F7" : colors.cyan}60`,
            }}
          >
            {isCapturing ? (
