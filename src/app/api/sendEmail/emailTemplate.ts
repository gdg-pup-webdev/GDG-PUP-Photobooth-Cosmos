                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="center" style="padding: 16px 0;">
                          <table role="presentation" cellspacing="0" cellpadding="0" style="background: linear-gradient(135deg, ${colors.blue}, ${colors.cyan}); border-radius: 12px; box-shadow: 0 8px 20px rgba(87,202,255,0.3);">
                            <tr>
                ...
                <tr>
                  <td align="center">
                    ...
                    <p class="muted-text" style="margin: 12px 0 0 0; font-size: 11px; color: #666666;">
                      Powered by <strong style="color: ${colors.cyan};">GDG on Campus PUP</strong>
                    </p>
